...
#include "DRRPlayerMiniProjectileProto.generated.h"

UCLASS()
class DRR_API ADRRPlayerMiniProjectileProto : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ADRRPlayerMiniProjectileProto();
...
public:
	...
	UFUNCTION()
	void OnStaticMeshOverlapBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
		UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
protected:
