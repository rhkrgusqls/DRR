...
#include "DRRPlayerActUnitProto5.generated.h"

/**
 * 
 */
UCLASS()
class DRR_API ADRRPlayerActUnitProto5 : public ADRRActUnitBase
{
	GENERATED_BODY()
public:
	ADRRPlayerActUnitProto5();
...
public:
	...
	TSubclassOf<class ADRRPlayerChainDiskProto> Projectile;
